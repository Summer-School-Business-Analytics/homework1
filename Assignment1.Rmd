...
As per above calculations, accuracy of the model is 93%.

_NIR:_

The No Information Rate
talks about the largest proportion of the observed classes. Calculating the actual classifications of each species, we gather the sum of each species and found they are equal [Versicolor = 50, Setosa = 50]. This means our NIR is .50. 

_Comparing NIR and accuracy: _

Comparing the NIR (0.50) and the accuracy percentage of (0.93), the accuracy of the model is greater than the NIR. Since in NIR (0.5), only the dominant class is taken into account, our prediction will be correct only 50% of the time. Thus We can conclude that the current model can predict the classifications 43% better than the NIR.
